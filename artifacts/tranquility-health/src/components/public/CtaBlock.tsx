...
export function CtaBlock({
  ...
  return (
    <div className="relative bg-gradient-to-br from-teal-500 via-emerald-600 to-teal-700 rounded-3xl px-8 py-14 text-center text-white overflow-hidden">
      <div className="absolute inset-0 opacity-15">
        <div className="absolute -top-10 -right-10 w-72 h-72 rounded-full bg-emerald-200" />
      ...
      <div className="relative">
        ...
        {subtext && <p className="mt-4 text-emerald-100 text-base max-w-xl mx-auto leading-relaxed">{subtext}</p>}
        <Link
          href={buttonHref}
